...
export class AddedNullableToSomeColumnsAndColumnDescription1681677652388 implements MigrationInterface {
    name = 'AddedNullableToSomeColumnsAndColumnDescription1681677652388'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "musical_group" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar(50) NOT NULL, "description" text NOT NULL, "membersQuantity" integer NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), CONSTRAINT "UQ_b2278cd2d0a9209514afae5dfc2" UNIQUE ("name"))`);
