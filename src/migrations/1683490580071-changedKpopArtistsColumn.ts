...
export class ChangedKpopArtistsColumn1683490580071 implements MigrationInterface {
    name = 'ChangedKpopArtistsColumn1683490580071'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "kpop_artists" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar(20) NOT NULL, "description" text, "image" varchar(256) NOT NULL, "vocal" integer NOT NULL, "dance" integer NOT NULL, "standardKorean" integer NOT NULL, "popularity" integer NOT NULL, "rap" integer NOT NULL, "stagePresence" integer NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "musicalGroupId" integer)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_kpop_artists" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar(20) NOT NULL, "description" text, "image" varchar(256) NOT NULL, "vocal" integer NOT NULL, "dance" integer NOT NULL, "standardKorean" integer NOT NULL, "popularity" integer NOT NULL, "rap" integer NOT NULL, "stagePresence" integer NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "musicalGroupId" integer, CONSTRAINT "FK_dac7a7109111cb819a3b10fbea2" FOREIGN KEY ("musicalGroupId") REFERENCES "musical_group" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_kpop_artists"("id", "name", "description", "image", "vocal", "dance", "standardKorean", "popularity", "rap", "stagePresence", "createdAt", "updatedAt", "musicalGroupId") SELECT "id", "name", "description", "image", "vocal", "dance", "standardKorean", "popularity", "rap", "stagePresence", "createdAt", "updatedAt", "musicalGroupId" FROM "kpop_artists"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "kpop_artists" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar(20) NOT NULL, "description" text, "image" varchar(256) NOT NULL, "vocal" integer NOT NULL, "dance" integer NOT NULL, "standardKorean" integer NOT NULL, "popularity" integer NOT NULL, "rap" integer NOT NULL, "stagePresence" integer NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "musicalGroupId" integer)`);
        await queryRunner.query(`INSERT INTO "kpop_artists"("id", "name", "description", "image", "vocal", "dance", "standardKorean", "popularity", "rap", "stagePresence", "createdAt", "updatedAt", "musicalGroupId") SELECT "id", "name", "description", "image", "vocal", "dance", "standardKorean", "popularity", "rap", "stagePresence", "createdAt", "updatedAt", "musicalGroupId" FROM "temporary_kpop_artists"`);
